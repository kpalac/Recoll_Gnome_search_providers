...
if len(sys.argv) > 1: 
    ...
    if arg == 'other':
        ...
        search_str = '(-dir:~/Mail AND -rclcat:book AND -rclcat:media AND -rclcat:doc AND -rclcat:code AND -rclcat:table AND -rclcat:image)'
