...
if not os.path.isdir('mail_dir') == '': mail_dir = '/dummy'
if not os.path.isdir('www_dir') == '': www_dir = '/dummy'
...
if len(sys.argv) > 1: 
    ...
    if arg == 'other':
        ...
        search_str = f'(-dir:"{mail_dir}" AND -dir:"{www_dir}" AND -rclcat:book AND -rclcat:media AND -rclcat:docs AND -rclcat:code AND -rclcat:table AND -rclcat:image AND -rclcat:message AND -rclcat:www)'

    elif arg == 'mail':
        search_mode = 1
        _myname = 'org.recoll.RecollMail.SearchProvider'
        if mail_dir == '/dummy': search_str = f'rclcat:message{excluded_dirs_str}'
        else: search_str = f'dir:"{mail_dir}"{excluded_dirs_str}'

    elif arg == 'www':
        search_mode = 11
        _myname = 'org.recoll.RecollWWW.SearchProvider'
        if www_dir == '/dummy': search_str = f'rclcat:www{excluded_dirs_str}'
        ...
        search_str = f'-dir:"{mail_dir}" AND -dir:"{www_dir}" AND rclcat:docs{excluded_dirs_str}'

    elif arg == 'media': 
        search_mode = 3
        _myname = 'org.recoll.RecollMedia.SearchProvider'
        search_str = f'-dir:"{mail_dir}" AND -dir:"{www_dir}" AND rclcat:media{excluded_dirs_str}'

    elif arg == 'books':
        search_mode = 4
        _myname = 'org.recoll.RecollBooks.SearchProvider'
        search_str = f'-dir:"{mail_dir}" AND -dir:"{www_dir}" AND rclcat:book{excluded_dirs_str}'

    elif arg == 'code': 
        search_mode = 5
        _myname = 'org.recoll.RecollCode.SearchProvider'
        search_str = f'-dir:"{mail_dir}" AND -dir:"{www_dir}" AND rclcat:code{excluded_dirs_str}'

    elif arg == 'data': 
        search_mode = 5
        _myname = 'org.recoll.RecollData.SearchProvider'
        search_str = f'-dir:"{mail_dir}" AND -dir:"{www_dir}" AND rclcat:table{excluded_dirs_str}'

    elif arg == 'images': 
        search_mode = 5
        _myname = 'org.recoll.RecollImages.SearchProvider'
        search_str = f'-dir:"{mail_dir}" AND -dir:"{www_dir}" AND rclcat:image{excluded_dirs_str}'
