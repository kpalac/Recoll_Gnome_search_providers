...
if len(sys.argv) > 1: 
    ...
    if arg == 'other':
        ...
        search_str = '(-dir:~/Mail AND -rclcat:book AND -rclcat:media AND -rclcat:docs AND -rclcat:code AND -rclcat:table AND -rclcat:image)'
        ...
        search_str = '-dir:~/Mail AND rclcat:docs'

    elif arg == 'media': 
        search_mode = 3
        _myname = 'org.recoll.RecollMedia.SearchProvider'
        search_str = '-dir:~/Mail AND rclcat:media'

    elif arg == 'books':
        search_mode = 4
        _myname = 'org.recoll.RecollBooks.SearchProvider'
        search_str = '-dir:~/Mail AND rclcat:book'

    elif arg == 'code': 
        search_mode = 5
        _myname = 'org.recoll.RecollCode.SearchProvider'
        search_str = '-dir:~/Mail AND rclcat:code AND -issub:1'

    elif arg == 'data': 
        search_mode = 5
        _myname = 'org.recoll.RecollData.SearchProvider'
        search_str = '-dir:~/Mail AND rclcat:table AND -issub:1'

    elif arg == 'images': 
        search_mode = 5
        _myname = 'org.recoll.RecollImages.SearchProvider'
        search_str = '-dir:~/Mail AND rclcat:image'
